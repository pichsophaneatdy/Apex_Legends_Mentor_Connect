  ...
  return (
    <div className="mentee-form">
      ...
      <section className="mentee-form__value-options">
        <MenteeFormOption
          selectValue={"bronze"}
          filterValue={filterSkill}
          setFilterValue={setFilterSkill}
          imgSrc={bronzeIcon}
          classSelect={"value-select"}
        />
        <MenteeFormOption
          selectValue={"silver"}
          filterValue={filterSkill}
      ...
      <section className="mentee-form__value-options">
        <MenteeFormOption
          selectValue={"public games"}
          filterValue={filterMode}
          setFilterValue={setFilterMode}
          imgSrc={casualIcon}
          classSelect={"value-select"}
        />
        <MenteeFormOption
      ...
      <section className="mentee-form__character-options">
        <MenteeFormOption
          ...
          setFilterValue={setFilterCharacter}
          imgSrc={assaultIcon}
          classSelect={"character-select"}
        />
        <MenteeFormOption
          selectValue={"recon"}
          filterValue={filterCharacter}
        ...
        />
        <MenteeFormOption
          selectValue={"skirmisher"}
          filterValue={filterCharacter}
          setFilterValue={setFilterCharacter}
          imgSrc={skirmisherIcon}
          classSelect={"character-select"}
        />
        <MenteeFormOption
